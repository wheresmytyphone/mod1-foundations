...
describe('iterator', function() {
  ...
  it('can FILTER out strings shorter or equal to 4 letters', function() {
    var factory = new Iterator();

    assert.deepEqual(factory.shortWords(['potato', 'bird', 'ham', 'lasagna', 'pants', 'bro', 'consternation']), ['bird', 'ham', 'bro']);
  });

  it('can return a new array of uppercase strings using MAP', function() {
    var factory = new Iterator();

    assert.deepEqual(factory.uppercaseArray(['potato', 'bird', 'ham', 'pants']), ['POTATO', 'BIRD', 'HAM', 'PANTS']);
  });

  it('can return a new array of integers that are increased by 10 using MAP', function() {
    var factory = new Iterator();

    assert.deepEqual(factory.addTen([1, 2, 3, 4, 5]), [11, 12, 13, 14, 15]);
  });

  it('can return an array of data types based on each element', function() {
    var factory = new Iterator();
  ...
  it('can FILTER for meals that contain basil', function() {
    var factory = new Iterator();
  ...
  it('can SORT an array of numbers in reverse order', function() {
    var factory = new Iterator();
  ...
  it('can MAP over a SORTED array returning meals in order of most ingredients ', function() {
    var factory = new Iterator();
